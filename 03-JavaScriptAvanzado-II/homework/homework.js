...
// Crea una función que recibe como argumento una función callback
function cacheFunction(cb) {
  // Crea un objeto vacío
  const obj = {}

  // Devuelve una función que recibe un argumento
  return function (arg) {
    // Si el objeto tiene una propiedad con el argumento dado
    if(obj.hasOwnProperty(arg))
      // Devuelve el valor almacenado en esa propiedad
      return obj[arg];
    // Si no, calcula el resultado de la callback con el argumento dado
    obj[arg] = cb(arg);
    // Almacena el resultado en una propiedad del objeto usando el argumento como clave
    return obj[arg];
  }
}
